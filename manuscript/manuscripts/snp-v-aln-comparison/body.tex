...
\jrocomment{[These results still need to be incorporated]}.
...
Will this amplify the affect of error and bias? Or will it   


Our sample size of 4 gene copies is quite small. In order to gain high confidence
...
mutational or basecalling error. 

Investigate whether it might be better to sequence a larger number of individuals
from a population at lower coverage. \citep{alexbuerklePopulationGenomicsBased2013}
