...
\subsection{Applicability to empirical data sets}
% Application
...
This suggests that investigators might be better off analyzing all their data,
rather than discarding much of it to avoid violating an assumption of the
model.
However, it remains to be seen whether this holds true for larger trees\ldots
