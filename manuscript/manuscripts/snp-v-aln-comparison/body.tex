...
Nonetheless, the tree topology is frequently a parameter of great interest and
it would therefore be interesting to know how bias affects estimation of the
...
root population, or maybe the most basal branches of the species tree.
