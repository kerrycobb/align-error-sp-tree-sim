...
instruments are becoming commonplace in phylogenetics \citep{leacheUtilitySingleNucleotide2017}, and
...
\citep{liuSpeciesTreesGene2007, heledBayesianInferenceSpecies2010, ogilvieStarBEAST2BringsFaster2017,
...
\citep{yangBPPProgramSpecies2015,ogilvieStarBEAST2BringsFaster2017}.
...
% \citep{airdAnalyzingMinimizingPCR2011}.
...
\citep{harveySimilarityThresholdsUsed2015,huang2016unforeseen,linckMinorAlleleFrequency2019}.
...
\citep[Version 0.3.2, Commit a7e9bf2;][]{oaksFullBayesianComparative2019}
...
unlinked-character model of \ecoevolity \citep{bryantInferringSpeciesTrees2012,oaksFullBayesianComparative2019}. Therefore, we also analyzed each data 
...
200 and PSRF less than 1.2 \citep{Brooks1998} to indicate adequate convergence
...
% with \citep{oaksFullBayesianComparative2019} 
...
\citep{oaksFullBayesianComparative2019,oaks2019comparative},
