...
under the same model as those used for inference in \beast and \ecoevolity.
...
The accuracy and precision of descendant effective population size
...
Looking for inflated effective population sizes in an internal node could be
indicative of a problem with estimates.
