...
at
\url{https://github.com/kerrycobb/align-error-sp-tree-sim}\highLight{XXXXXX},
and includes
...
variable site per locus or only the variable sites. While the unlinked model are 
likely to perform more poorly than linked models, they are generally robust to 
the error. Below we discuss why performance differs between methods, locus 
lengths, and degree of error in the data and discuss what this understanding 
means for the analysis of empirical data. 
