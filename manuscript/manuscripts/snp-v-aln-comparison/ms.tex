...
\newcommand{\jrocomment}[1]{{\color{pgreen}{[JRO comment: #1]}}}
\newcommand{\kaccomment}[1]{{\color{pgreen}{[KAC comment: #1]}}}
...
\bibliography{../../bib/references, ../../bib/kac_zotero}
% \bibliography{../../bib/references}
% \bibliography{../../bib/kac_zotero.bib}
