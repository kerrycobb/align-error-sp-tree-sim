\newcommand{\figlegend}{TEST TEST TEST The left column shows estimates from \beast. The center 
column shows estimates from \ecoevolity using all sites and the
